...
pub const METHODS: &[Method] = &[
    ...
    public_instance_method("java/util/Random", "nextBoolean", "()Z"),
    public_instance_method("java/util/Random", "nextDouble", "()D"),
    public_instance_method("java/util/Random", "nextFloat", "()F"),
    public_instance_method("java/util/Random", "nextInt", "()I"),
    public_instance_method("java/util/Random", "nextInt", "(I)I"),
    public_instance_method("java/util/Random", "nextLong", "()J"),
