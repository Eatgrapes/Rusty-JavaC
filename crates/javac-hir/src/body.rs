...
impl Expr {
    pub fn ty(&self, exprs: &Arena<Expr>) -> Ty {
        match self {
            ...
            Expr::StringLiteral(_) => Ty::Class(ustr::Ustr::from("java/lang/String")),
            Expr::NullLiteral => Ty::Class(ustr::Ustr::from("java/lang/Object")),
            Expr::This => Ty::Class(ustr::Ustr::from("java/lang/Object")),
            Expr::Super => Ty::Class(ustr::Ustr::from("java/lang/Object")),
            Expr::Ident(_) => Ty::Int,
            ...
            Expr::Lambda { .. } => Ty::Class(ustr::Ustr::from("java/lang/Object")),
            Expr::MethodRef { .. } => Ty::Class(ustr::Ustr::from("java/lang/Object")),
