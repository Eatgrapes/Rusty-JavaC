...
use crate::hir::lowering::anonymous;
use crate::hir::lowering::literal;
use crate::hir::lowering::syntax::ExprToken;
use crate::hir::lowering::types::{TypeResolver, class_type_from_name, lower_type};
...
pub(super) struct BodyBuilder {
    pub body: Body,
    pub(super) type_resolver: TypeResolver,
    local_scopes: Vec<HashMap<Ustr, Ty>>,
    pattern_names: HashSet<Ustr>,
    pub(super) anonymous_types: Vec<Rc<TypeDecl>>,
    pub(super) anonymous_counter: Rc<Cell<u32>>,
    pub(super) can_capture_this: bool,
    pub(super) enclosing_static_owner: Option<Ustr>,
    pub(super) outer_fields: Vec<CapturedField>,
}
...
impl BodyBuilder {
    ...
    pub(super) fn lower_type(&self, node: &crate::ast::JavaSyntaxNode) -> LowerResult<Ty> {
...
impl ExprLowerer<'_, '_> {
    ...
    fn finish_anonymous_object(&mut self, base_type: Ty, args: Vec<ExprId>) -> LowerResult<ExprId> {
        ...
        anonymous::lower_object(self.body, base_type, args, body_tokens)
    }
